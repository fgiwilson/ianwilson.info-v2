...
export const defaultMeta: SeoProps = {
  title: 'Ian Wilson | Strategic Operations Professional, Technology & Process Innovation, Data-Driven Solutions, Team Leadership',
...
export function generateSeoTags(meta: SeoProps = {}) {
  ...
  const defaultTitle = defaultMeta.title || 'Ian Wilson | Strategic Operations Professional, Technology & Process Innovation, Data-Driven Solutions, Team Leadership';
