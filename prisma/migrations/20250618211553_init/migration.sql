...
-- CreateIndex
CREATE UNIQUE INDEX "BlogPost_coverImageId_key" ON "BlogPost"("coverImageId");
...
-- AddForeignKey
ALTER TABLE "_BlogPostImages" ADD CONSTRAINT "_BlogPostImages_A_fkey" FOREIGN KEY ("A") REFERENCES "BlogPost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BlogPostImages" ADD CONSTRAINT "_BlogPostImages_B_fkey" FOREIGN KEY ("B") REFERENCES "Media"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ProjectImages" ADD CONSTRAINT "_ProjectImages_A_fkey" FOREIGN KEY ("A") REFERENCES "Media"("id") ON DELETE CASCADE ON UPDATE CASCADE;
